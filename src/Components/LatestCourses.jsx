                        ...
                        latestCourse.length>0 && (
                            latestCourse.map(lCourse=>{
                                return(
                                    ...
                                    <CourseBox discount={lCourse.discount} key={lCourse._id} name={lCourse.name} shortName={lCourse.shortName} creator={lCourse.creator} registers={lCourse.registers} price={lCourse.price} courseAverageScore={lCourse.courseAverageScore} cover={lCourse.cover}/>
                                )
                            })
                        )
                    }
